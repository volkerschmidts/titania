...
function(enable_sanitizers proj_name)
  ...
  if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU" OR CMAKE_CXX_COMPILER_ID MATCHES
    ...
    if(ENABLE_COVERAGE)
      target_compile_options(${proj_name} INTERFACE --coverage -O0 -g)
      target_link_libraries(${proj_name} INTERFACE --coverage)
    endif()
  ...
  if(LIST_OF_SANITIZERS)
    if(NOT
      ...
      target_link_options(${proj_name} INTERFACE
